...
var Router = map[string]*Command{
	...
	"HSET":      {execHset, undoHSet, 3},
	"HGET":      {execHget, nil, 2},
	"HEXISTS":   {execHexists, nil, 2},
	"HDEL":      {execHdel, undoHDel, -2},
	"LPUSH":     {execLPush, undoLPush, -2},
	"LPOP":      {execLPop, undoLPop, 1},
	"LRANGE":    {execLRange, nil, 3},
	"RPUSH":     {execRPush, undoRPush, -2},
	"ZADD":      {execZAdd, undoZAdd, 3},
	"ZSCORE":    {execZScore, nil, 2},
	"ZRANGE":    {execZRange, nil, 3},
	"SADD":      {execSAdd, undoSAdd, -2},
	"SREM":      {execSRem, undoSRem, -2},
